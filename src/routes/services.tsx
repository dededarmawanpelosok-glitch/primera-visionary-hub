    ...
    <>
        ...
        <div className="container-x">
          <Reveal>
            ...
            <h1 className="font-display text-6xl md:text-8xl mt-6 leading-[0.9] max-w-4xl text-balance">
              Integrated services for people-driven performance
            </h1>
            <p className="mt-8 max-w-2xl text-ink/70 leading-relaxed">
              We design and deliver end-to-end solutions across recruitment, training, leadership, sales capability, consulting, and digital learning — built to create measurable business impact.
            </p>
          </Reveal>
        </div>
      </section>
            ...
            return (
              <Reveal key={s.slug} delay={i * 0.05}>
                <div className="group bg-white p-8 md:p-10 h-full lift hover:bg-cream/60">
                  ...
                  <Link to="/contact" className="mt-6 inline-flex items-center gap-2 text-sm underline underline-offset-4">Discuss this service <ArrowRight className="h-4 w-4" /></Link>
                </div>
              </Reveal>
            );
          })}
      ...
      <section className="bg-ink text-cream py-24">
        <div className="container-x text-center">
          <Reveal>
            <h2 className="font-display text-5xl md:text-6xl">Ready to design your engagement?</h2>
